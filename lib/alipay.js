...
var moment = require('moment'),
  ...
  debug = require('debug')('third-payment:alipay'),
...
Alipay.prototype.verify_async_openapi = function(params){
 ...
 Alipay.prototype.verify_notify = function(notify_id){
   ...
   var options = {
     url : 'https://mapi.alipay.com/gateway.do?service=notify_verify&partner=PARTNER_ID&notify_id=NOTIFY_ID'.replace('PARTNER_ID', this.config.partner).replace('NOTIFY_ID', notify_id)
   }
